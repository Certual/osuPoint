...
1. Stop conflicting Wacom services:
   If official Wacom software is installed, open Task Manager -> Services tab -> locate WTabletServicePro or Wacom Professional Service and stop them. Otherwise, Windows will lock the tablet's USB handle.
2. Run driver.exe.
